	...
	function Xe(e, t, a, o) {
		for (var r = [], n = 0; n < e.length; n++) {
			...
			if (s) {
				...
				r.push(
					'<span class="sp-thumb-el sp-clear-display" ><span class="sp-clear-palette-only" style="background-color: transparent;" /></span>'
				)
		}
	...
	function n(e, t) {
		var a,
			...
			h = (function (e, t) {
				;(e.locale = e.locale || window.navigator.language),
					e.locale &&
						(e.locale = e.locale.split('-')[0].toLowerCase()),
					'en' != e.locale &&
						De.spectrum.localization[e.locale] &&
						(e = De.extend(
							{},
							De.spectrum.localization[e.locale],
							e
		...
		function me() {
			if (
				...
				h.showPaletteOnly &&
					!h.color &&
					(ne = '' === S[0][0] ? S[0][0] : Object.keys(z)[0])
			}
		...
		function xe(e) {
			if (i) {
				...
				if (!z[t] && -1 === De.inArray(t, j))
					for (j.push(t); j.length > A; ) j.shift()
				if (l)
					try {
		...
		function we() {
			;(m <= 0 || b <= 0 || x <= 0) && Qe(),
				...
				E.addClass(R),
				(H = null),
				O.trigger('dragstart.spectrum', [Re()])
		}
		function _e() {
		...
		function ze() {
			p &&
				!d &&
				((p = !1),
				De(L).off('keydown.spectrum', Se),
				De(L).off('click.spectrum', Me),
				De(window).off('resize.spectrum', f),
				ae.removeClass('sp-active'),
				E.addClass('sp-hidden'),
				u.hide(Re()),
				O.trigger('hide.spectrum', [Re()]))
		}
		function je() {
			Ae(se, !0), Oe(!0)
		}
			...
			tinycolor.equals(e, Re())
				...
				: ((e && e !== qe) || !ue
				  ...
				  a &&
						a.isValid() &&
						!t &&
						(ie = h.preferredFormat || a.getFormat()))
		}
		function Re(e) {
			return (
				(e = e || {}),
				ue && ce
					? null
					: tinycolor.fromRatio(
							{ h: _, s: k, v: P, a: Math.round(1e3 * C) / 1e3 },
							{ format: e.format || ie }
					  )
			)
		}
		...
		function He() {
			...
			var a = Re({ format: t }),
				o = ''
			if (
				(re.removeClass('sp-clear-display'),
				re.css('background-color', 'transparent'),
				!a && ue)
			)
				re.addClass('sp-clear-display')
			else {
				var r = a.toHexString(),
					n = a.toRgbString()
				if (
					(Be || 1 === a.alpha
						? re.css('background-color', n)
						: (re.css('background-color', 'transparent'),
						  re.css('filter', a.toFilter())),
					h.showAlpha)
				) {
					var s = a.toRgb()
					s.a = 0
					...
					We
						? W.css(
								'filter',
								tinycolor(i).toFilter({ gradientType: 1 }, r)
						  )
						: (W.css('background', '-webkit-' + l),
						  W.css('background', '-moz-' + l),
						  W.css('background', '-ms-' + l),
						  W.css(
								'background',
			...
			if (
				(h.showInput && $.val(o),
				O.val(o),
				'text' == h.type || 'component' == h.type)
			) {
				var c = a
				if (c && he) {
					var u =
						c.isLight() || c.getAlpha() < 0.4 ? 'black' : 'white'
		...
		function Le() {
			...
			if (ue && ce) K.hide(), V.hide(), q.hide()
				...
				var a = e * b,
					o = m - t * m
				;(a = Math.max(-v, Math.min(b - v, a - v))),
					(o = Math.max(-v, Math.min(m - v, o - v))),
					q.css({ top: o + 'px', left: a + 'px' })
				var r = C * y
				K.css({ left: r - T / 2 + 'px' })
				var n = _ * x
				V.css({ top: n - w + 'px' })
		...
		function Oe(e) {
			...
			t && (t.toString(ie), xe(t)),
				e && a && (u.change(t), (F = !0), O.trigger('change', [t]))
		}
		function Qe() {
		...
		!(function () {
			if (
				...
				fe.addClass('sp-colorize-container'),
					O.addClass('spectrum sp-colorize').wrap(fe)
			else if ('component' == s) {
			...
			if (
				((he = O.parent().find('.sp-colorize')),
				(de = he.css('color')),
				(pe = he.css('background-color')),
				ue || U.hide(),
				d)
			)
				O.after(E).hide()
				...
				return (
					e.data && e.data.ignore
						...
						: (Ae(
						  ...
						  Fe(),
						  h.hideAfterPaletteSelect ? (Oe(!0), ze()) : Oe()),
					!1
				)
			}
			ve(),
				oe.on('click.spectrum touchstart.spectrum', function (e) {
					Q || Pe(),
						e.stopPropagation(),
						De(e.target).is('input') || e.preventDefault()
				}),
				...
				J.on('click.spectrum', function (e) {
					e.stopPropagation(),
						e.preventDefault(),
						We && $.is(':focus') && $.trigger('change'),
						$.hasClass('sp-validation-error') || (Oe(!0), ze())
				}),
				Z.text(
					h.showPaletteOnly
						? h.togglePaletteMoreText
				...
				Ue(
					...
					function (e, t, a) {
						;(C = e / y),
							(ce = !1),
							a.shiftKey && (C = Math.round(10 * C) / 10),
							Fe()
					},
					we,
					_e
				...
				Ue(
					...
					function (e, t, a) {
						...
						var s = !H || 'y' === H
						;(H && 'x' !== H) || (k = parseFloat(e / b)),
							s && (P = parseFloat((m - t) / m)),
							(ce = !1),
							h.showAlpha || (C = 1),
							Fe()
					},
				...
				ne
					? (Ae(ne),
					  He(),
					  (ie = tinycolor(ne).format || h.preferredFormat),
					  xe(ne))
					: ('' === ne && Ae(ne), He()),
				d && Ce()
			var o = We
			...
			X.on(o, '.sp-thumb-el', a),
				Y.on(o, '.sp-thumb-el:nth-child(1)', { ignore: !0 }, a)
		})()
		var Ne = {
			show: Ce,
			hide: ze,
			...
			option: function (e, t) {
				return e === qe
					...
					? h[e]
					: ((h[e] = t),
					  'preferredFormat' === e && (ie = h.preferredFormat),
					  void me())
			},
			enable: function () {
			...
			get: Re,
			destroy: function () {
				O.show().removeClass('spectrum with-add-on sp-colorize'),
					oe.off('click.spectrum touchstart.spectrum'),
					E.remove(),
					ae.remove(),
					he && he.css('background-color', pe).css('color', de)
	...
	function Ue(s, i, t, e) {
		...
		;(a.selectstart = p),
			...
			De(s).on('touchstart mousedown', function (e) {
				;(e.which ? 3 == e.which : 2 == e.button) ||
					c ||
					(!1 !== t.apply(s, arguments) &&
						((c = !0),
						(f = De(s).height()),
						(h = De(s).width()),
						(u = De(s).offset()),
						De(l).on(a),
						De(l.body).addClass('sp-dragging'),
						o(e),
						p(e)))
			})
	}
	...
	;(De.fn.spectrum = function (a, e) {
		if ('string' != typeof a)
			return this.spectrum('destroy').each(function () {
				...
				De(this).is('input')
					? e.flat || 'flat' == e.type
						? (e.type = 'flat')
						: 'color' == De(this).attr('type')
						? (e.type = 'color')
						: (e.type = e.type || 'component')
					: (e.type = 'noInput')
				var t = n(this, e)
				De(this).data(s, t.id)
			})
			...
			this.each(function () {
				...
				if (e) {
					...
					'get' == a
						...
						? (o = e.container)
						: 'option' == a
						? (o = e.option.apply(e, r))
						: 'destroy' == a
						? (e.destroy(), De(this).removeData(s))
						: t.apply(e, r)
				}
			}),
			o
		...
		(function () {
			...
			function d(e, t, a, o) {
				var r
				return [
					R(((r = o), Math.round(255 * parseFloat(r)).toString(16))),
					R(i(e).toString(16)),
					R(i(t).toString(16)),
					R(i(a).toString(16)),
				].join('')
			...
			function m(e, t) {
				...
				var a = h(e).toRgb()
				return (
					(a.r = f(0, u(255, a.r - i((-t / 100) * 255)))),
					(a.g = f(0, u(255, a.g - i((-t / 100) * 255)))),
					(a.b = f(0, u(255, a.b - i((-t / 100) * 255)))),
					h(a)
				)
			}
			function v(e, t) {
			...
			function T(e) {
				...
				return [
					h(e),
					h({ h: (a + 120) % 360, s: t.s, l: t.l }),
					h({ h: (a + 240) % 360, s: t.s, l: t.l }),
				]
			}
			function w(e) {
				var t = h(e).toHsl(),
				...
				return [
					h(e),
					h({ h: (a + 90) % 360, s: t.s, l: t.l }),
					h({ h: (a + 180) % 360, s: t.s, l: t.l }),
			...
			function _(e) {
				...
				return [
					h(e),
					h({ h: (a + 72) % 360, s: t.s, l: t.l }),
					h({ h: (a + 216) % 360, s: t.s, l: t.l }),
				]
			}
			function k(e, t, a) {
				;(t = t || 6), (a = a || 30)
			...
			;(h.prototype = {
				...
				toName: function () {
					return 0 === this._a
						? 'transparent'
						: !(this._a < 1) &&
								(S[t(this._r, this._g, this._b, !0)] || !1)
				},
				toFilter: function (e) {
				...
				(h.equals = function (e, t) {
					return (
						!(!e || !t) && h(e).toRgbString() == h(t).toRgbString()
					)
				}),
				(h.random = function () {
			...
			function z(e, t) {
				...
				return (
					(e = u(t, f(0, parseFloat(e)))),
					r && (e = parseInt(e * t, 10) / 100),
					c.abs(e - t) < 1e-6 ? 1 : (e % t) / parseFloat(t)
				)
			}
			function j(e) {
				return u(1, f(0, e))
